# PokeMMO: 1-Hour 30-Gym Rerun (NO LONGER WORKS AS OF HALLOWEEN 24' UPDATE)
...
• **Please note:** this run heavily relies on good RNG and your team being able to hit/be hit sufficiently. There is a breakdown of the team composition in JinxedBoon's video, which I have attached as a reference in the credit given above. 29 Gyms is the average amount achievable in 1 hour. The 30th Gym is only really accessible with financial boosts if no player or AI issues occur.<br><br>• **If Cottonee remains on the field after turn 1, always press Memento on turn 2 (DO NOT switch).**<br><br>• It is advised to use riches charm items before battling Wattson because if T&L lead Wobbufet, multiple Gyms will be discounted from the financial bonus.<br><br>• Gym Leaders with *(Full HP)* in front of the turn order means the main attacking Pokémon require being topped up with healing potions (if necessary) before starting the battle.
...
||**TPH**||
| 7. **Brawley** | Tailwind, Explosion + x2 Eruption | • Fake Out Scrafty on Cottonee allows Zangoose to out-speed - crits suck |
||**TPH & go to Kanto**||
...
||**TPH**||
| 12. **Misty** | Tailwind, Explosion + x2 Eruption | • Kingdra lead is a roll to kill<br>• Floatzel lead may require Specs Spout<br>• Lovely Kiss Poliwrath lead can put Torkoal to sleep and Ice Beam Politoed will take out one side - use on Memento Poliwrath if required |
||**TPH & go to Unova**||
...
| **Leader** | **Moves** | **Details** |
|-|-|-|
| 13. **Burgh** | Tailwind, Explosion + x2 Eruption | • Dig Flygon is annoying - crits suck |
...
||**TPH**||
| 18. **Elesa** | Tailwind, Explosion + Eruption, Specs Spout | • If Milotic, x2 Eruption |
||**Shift Typhlosions & TPH**||
| 19. **Clay** | Tailwind, Explosion + x2 Eruption | • Fake Out Sableye on Cottonee does not matter |
||**TPH**||
| 20. **Iris** | Tailwind, Explosion + x2 Eruption | • Grass + Water Pledge halves speed for 4 turns = good chance to lose. Just move on<br>• ExtremeSpeed Dragonite on Cottonee does not matter |
...
| **Leader** | **Moves** | **Details** |
|-|-|-|
| 21. **Gardenia** | x2 Eruption | • Milotic is a roll to kill - accuracy drops suck<br>• Hidden Power Lilligant lead out-speeds & Power Herb, Dig Leafeon out-speeds - crits suck |
||**TPH**||
...
| 29. **Chuck** | Tailwind, Explosion + x2 Eruption | • Mach Punch Hitmonchan on Cottonee does not matter |
| 30. **Morty** | x2 Eruption | • Cursed Body Gengar or Froslass requires a switch to Blastoise and back if disabled<br>• Watch out for Cursed Body + Focus Sash 😃<br>• **Chandelure DOES NOT have Flash Fire**<br>• Mantine is a roll to kill - crits suck |
||**TPH**||
